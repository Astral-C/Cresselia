...
class UCresseliaContext {

	std::string mQueuedTool = "";
	std::string mCurrentTool = "Map Header Table";
	std::vector<std::string> mEditorTools = { "Map Header Table", "Chunk Editor", "Matrix Editor", "Area Editor", "Encounter Editor", "Trainer Editor"};
